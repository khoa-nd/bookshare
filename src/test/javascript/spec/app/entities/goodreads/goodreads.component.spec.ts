...
import { GoodreadsComponent } from 'app/entities/goodreads/goodreads.component';
...
describe('Component Tests', () => {
  describe('Goodreads Management Component', () => {
    let comp: GoodreadsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(GoodreadsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.goodreads[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
